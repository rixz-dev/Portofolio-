...
export const stack: StackItem[] = [
  ...
  { name: "JavaScript", level: 43, since: "2024" },
  { name: "Node.js", level: 43, since: "2024" },
  { name: "NPM", level: 71, since: "2024" },
  { name: "CSS", level: 12, since: "2025" },
  { name: "SQLite", level: 64, since: "2025" },
  { name: "Git & GitHub", level: 76, since: "2024" },
  { name: "Cryptography", level: 17, since: "2025" },
];
